...
const questions = [
    ...
    { number: 12, question: "Pada konsep awal, karakteristik big data terdiri dari 3 V yaitu...", options: ["Volume, Viscosity, Variety", "Volume, Value, Viscosity", "Volume, Variety, Value", "Volume, Verbosity, Value", "Volume, Viscosity, Value"], answer: 2 },
